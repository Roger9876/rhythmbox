...
import { rhythmboxLogo } from '../assets';
  ...
  return (
    <>
      <div className="md:flex hidden flex-col w-[240px] py-10 px-4 bg-[#191624]">
        <img src={rhythmboxLogo} alt="logo" className="w-full h-24 object-contain" />
        <NavLinks />
      </div>
      ...
      >
        <img src={rhythmboxLogo} alt="logo" className="w-full h-14 object-contain" />
